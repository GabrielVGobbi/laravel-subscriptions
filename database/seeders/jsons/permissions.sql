...
*/
INSERT INTO `permissions` (`name`,`groups`,`slug`,`description`) VALUES ('Acesso ao Painel Administrativo','Painel','panel','Permissão para acessar o Painel Administrativo');
